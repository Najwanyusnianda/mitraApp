...
class DashboardController extends Controller
{
    ...
    public function index(){
        $kegiatan=KegiatanMitra::query()->join('mitras','mitras.id','=','kegiatan_mitras.mitra_id')
       ...
       ->select('kegiatans.id AS id','kegiatans.tahun AS tahun','master_kegiatans.seksi','kegiatans.nama_kegiatan','kegiatans.pelaksanaan_mulai','kegiatans.pelaksanaan_selesai','kegiatans.pelatihan_mulai','kegiatans.pelatihan_selesai',DB::raw('COUNT(kegiatan_mitras.mitra_id) as count'))
   ...
   if($count_kecamatan->isEmpty()){
     ...
     if ($counts_kecamatan->isEmpty()) {
      ...
      ->WhereRaw('? BETWEEN kegiatans.pelaksanaan_mulai and pelaksanaan_selesai', [$now_time])
      ->groupBy('kegiatan_mitras.kegiatan_id')
      ->select('kegiatans.id AS id','master_kegiatans.seksi','kegiatans.tahun AS tahun','kegiatans.nama_kegiatan','kegiatans.pelaksanaan_mulai','kegiatans.pelaksanaan_selesai','kegiatans.pelatihan_mulai','kegiatans.pelatihan_selesai',DB::raw('COUNT(kegiatan_mitras.mitra_id) as count'))
      ->latest('kegiatans.created_at')
      ->get();
